...
st.markdown(
    ...
    @keyframes slide {
        ...
        100% { background: url('https://images.unsplash.com/photo-1480288828958-3072ad1606c1?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTY5fHxjYXIlMjBibHVlcHJpbnR8ZW58MHx8MHx8fDA%3D'); }
    }
