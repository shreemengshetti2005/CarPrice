...
st.markdown(
    ...
    @keyframes slide {
        ...
        100% { background: url('https://images.unsplash.com/photo-1587171024200-fde609729a2d?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxjb2xsZWN0aW9uLXBhZ2V8MTI1fDgyMTg0NTE4fHxlbnwwfHx8fHw%3D'); }
    }
